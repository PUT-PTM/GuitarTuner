 ...
 */
typedef struct {
	double* Input;               /*!< Pointer to data input buffer. Its length must be 2 * FFT_Size */
	double* Output;              /*!< Pointer to data output buffer. Its length must be FFT_Size */
 ...
 * @param  *InputBuffer: Pointer to buffer of type double with FFT_Size * 2 length
 * @param  *OutputBuffer: Pointer to buffer of type double with FFT_Size length
 * @retval None
 */
void TM_FFT_SetBuffers_F32(TM_FFT_F32_t* FFT, double* InputBuffer, double* OutputBuffer);
 ...
 */
uint8_t TM_FFT_AddToBuffer(TM_FFT_F32_t* FFT, double sampleValue);
